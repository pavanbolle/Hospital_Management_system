...
int main()
{
    ...
    do{
        ...
        printf("\t\t\t\t\t\t\t\t\t\t\t\n");
        printf("\t\t\t\t\t\t\t\t\t\t\n");
        printf("\t\t\t"""" WELCOME TO GANDHI HOSIPITAL, HYDERABAD!""""\n");
        printf("\t\t\t\t\t\t\t\t\t\t\n");
        printf("\t\t\t\t\t\t\t\t\t\t\n");
        printf("\t\t\t-------------------------------\n");
...
void table()
{
    ...
    printf("2.Accident/Severe wound/Bleeding\n");
    printf("3.Corona sevrity");
    printf("4.Chest pain\n");
    printf("5.Fracture\n");
    printf("6.Diabetes Checkup\n");
    printf("7.Infection\n");
    printf("8.Eye related\n");
    printf("9.Ear/nose\n");
     printf("10.Cough/common cold/headache\n");
}
